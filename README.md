...
**Sign-in help** in the web chat menu guides Qwen, Copilot and Z.ai users to provider-owned entry pages. It remembers an explicitly chosen Google/GitHub/Microsoft preference locally and offers an in-app or external-browser route. This is a guide, not automatic sign-in: embedded compatibility remains unverified and browser sessions are not transferred into Aistee.
